 ...
 * Based on vrx200 gphy.h from Daniel Schwierzeck, daniel.schwierzeck@gmail.com

 *
 * SPDX-License-Identifier:	GPL-2.0+
 */

#ifndef __ARX300_GPHY_H__
#define __ARX300_GPHY_H__

enum ltq_gphy_clk {
	/* XTAL 36 MHz input */
	LTQ_GPHY_CLK_36MHZ_XTAL,
	/* 25 MHz from PLL0 with divider */
	LTQ_GPHY_CLK_25MHZ_PLL0,
	/* 25 MHz Clock from Pin GPIO3 */
	LTQ_GPHY_CLK_25MHZ_GPIO3,
};
