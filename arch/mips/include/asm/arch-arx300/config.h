 ...
 *
 * Common board configuration for Lantiq XWAY ARX300 family
 *
 * Use following defines in your board config to enable specific features
 * and drivers for this SoC:
 *
 * CONFIG_LTQ_SUPPORT_UART
 * - support the ARX300 ASC/UART interface and console
 *
 * CONFIG_LTQ_SUPPORT_NAND_FLASH
 ...
 * - support the ARX300 ETOP and MAC interface
 */

#ifndef __ARX300_CONFIG_H__
#define __ARX300_CONFIG_H__

/* CPU and SoC type */
#define CONFIG_SOC_LANTIQ
#define CONFIG_SOC_XWAY_ARX300
 ...
 * PLL0: rational PLL running at ??? MHz
 * PLL1: DOES NOT EXIST??? // fractional PLL running at ??? MHz
 */
...
/* CPU speed */
#define CONFIG_SYS_CLOCK_MODE		LTQ_CLK_CPU_150_DDR_150
#define CONFIG_SYS_MIPS_TIMER_FREQ	75000000 // CONFIG_SYS_CLOCK_MODE / 2
