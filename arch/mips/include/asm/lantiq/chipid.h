...
enum ltq_chip_partnum {
	...
	LTQ_SOC_ARX362 = 0x0004,
	LTQ_SOC_ARX368 = 0x0005,
	LTQ_SOC_ARX382 = 0x0007,
	LTQ_SOC_ARX388 = 0x0008,
	LTQ_SOC_GRX388 = 0x0009,
};
...
#ifdef CONFIG_SOC_XWAY_ARX300
static inline int ltq_soc_is_arx300(void)
{
	return 1;
}
#else
